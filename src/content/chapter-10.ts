...
const whereItRuns: Block[] = [
  ...
  p(_('Concrete picture first. '), t('Claude Code', 'claude-code'), _(' is a program you run in your '), t('terminal', 'terminal'), _('. You give it a folder; it reads, edits, and runs commands inside that folder. The folder needs to be a '), t('git repo', 'repository'), _(', because the workflow ahead — branches, pull requests, reviewing the change — is git-shaped (Ch 8 if any of that is fuzzy).')),
